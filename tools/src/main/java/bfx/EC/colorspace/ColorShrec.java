...
class Subtree {
    ...
    private int combinedColors[][] = {{0,1,2,3},
                                      {1,0,3,2},
                                      {2,3,0,1},
                                      {3,2,1,0}};
    ...
    private int correctColorSpaceMismatch(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int mismatches = 0;
            ...
            if (matchingStrings != null) {
                ...
                for (int i = 0; i < skew.readIndex; i++) {
                    ...
                    synchronized(ColorShrec.sync[skew.readsPassingNode[i]/2]) {
                        // get the read
                        String read = new String(ColorShrec.reads[skew.readsPassingNode[i]]);
                        String trimmedRead;
                        ...
                        int errPos = trimmedRead.indexOf(prefix + key) + prefix.length() + key.length();
                        ...
                        while (possibleMatches.hasNext()) {
                            ...
                            } else if (trimmedRead.substring(errPos, errPos + s.length()).equals(s)) {
                                matchFound = true;
                                break;
                            }
                        }
                        ...
                        if (matchFound) {
                            ...
                            try {
                                read = read.substring(0, errPos) + correctToColor + read.substring(errPos + 1);
                                mismatches++;
                            } catch (Exception e) {
                            }
                            ...
                            ColorShrec.reads[skew.readsPassingNode[i]] = read.getBytes();

                            // correct the complement as well
                            if (skew.readsPassingNode[i] % 2 == 0) {
                                ColorShrec.reads[skew.readsPassingNode[i] + 1] = buildComplement(read.getBytes());
                            } else {
                                ColorShrec.reads[skew.readsPassingNode[i] - 1] = buildComplement(read.getBytes());
                            }
                        } else {
    ...
    private int correctColorSpaceDeletion(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int deletions = 0;
    ...
    private int correctColorSpaceInsertion(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int insertions = 0;
                    ...
                    for (int i = 0; i < skew.readIndex; i++) {
                        ...
                        synchronized(ColorShrec.sync[skew.readsPassingNode[i]/2]) {
                            ...
                            while (possibleMatches.hasNext()) {
                                ...
                                } else if (trimmedRead.subSequence(errPos, errPos + s.length()).equals(s)) {
                                    matchFound = true;
                                    break;
                                }
                            }
                            ...
                            if (matchFound) {
                                ...
                                char correctToColor = reliable.getColor();
                                try {
                                    read = read.substring(0, errPos) + correctToColor + read.substring(errPos);
                                    insertions++;
                                } catch (Exception e) {
                                }
    ...
    // Return the number of corrected mismatches
    private int correctBaseSpaceMismatch(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int mismatches = 0;
                ...
                if (relChild != null && matchingStrings != null) {
                    ...
                    for (int i = 0; i < skew.readIndex; i++) {
                        ...
                        synchronized(ColorShrec.sync[skew.readsPassingNode[i]/2]) {
                            ...
                            // half readNumber to match with the readNumber in the input-file.
                            readNumber = skew.readsPassingNode[i] / 2;
                            String baseRead = new String(ColorShrec.baseReads[readNumber]);

                            if (matchFound) {
                                // correct the read
                                String correctToColor = "" + reliable.getColor()
                                    + relChild.getColor();
                                String correctToBase = "";

                                try {
                                    read = read.substring(0, errPos) + correctToColor + 
                                        read.substring(errPos + 2);

                                    if (skew.readsPassingNode[i] % 2 == 0) {
                                        correctToBase = baseColor2Base
                                            [base2int(baseRead.charAt(errPos-2))]
                                            [color2int(reliable.getColor())];
                                        baseRead = baseRead.substring(0,errPos-1) +
                                            correctToBase + baseRead.substring(errPos);
                                    } else {
                                        int blen = baseRead.length();
                                        correctToBase = baseColor2Base
                                            [base2int(baseRead.charAt(blen - errPos - 1))]
                                            [color2int(reliable.getColor())];
                                        baseRead = baseRead.substring(0,blen - errPos -2) +
                                            correctToBase + baseRead.substring(blen-errPos-1);
                                    }
                                    mismatches++;
                                } catch (Exception e) {
                                }
                                ...
                                ColorShrec.reads[skew.readsPassingNode[i]] = read.getBytes();
                                ColorShrec.baseReads[skew.readsPassingNode[i]/2] = baseRead.getBytes();
...
//                                 baseRead = new String(Shrec.buildColorSpaceRead(Shrec.baseReads[readNumber]));

//                                 if (!read.equals(baseRead)) {
//                                     System.out.println("Mismatch: Corrected color read and base read do not match: " + skew.readsPassingNode[i]);
...
//                                 }
    ...
    // Return the number of corrected mismatches
    private int correctBaseSpaceMismatchN(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int mismatches = 0;
                    ...
                    if (relChild != null && matchingStrings != null) {
                        ...
                        for (int i = 0; i < skew.readIndex; i++) {
                            ...
                            synchronized(ColorShrec.sync[skew.readsPassingNode[i]/2]) {
                                ...
                                if (combColor == combinedColors
                                    [base2int((char)bread[pos-2])][base2int((char)bread[pos])]) {
...
//                                         }
    ...
    // Return the number of corrected deletions
    private int correctBaseSpaceDeletion(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int deletions = 0;
                        ...
                        if (matchFound) {
                            ...
                            try {
                                ...
                                if (skew.readsPassingNode[i] % 2 == 0) {
                                    ...
                                    int blen = baseRead.length();
                                    baseRead = baseRead.substring(0,blen - errPos - 2) +
                                        baseRead.substring(blen-errPos-1);
                                }
                                deletions++;
                            } catch (Exception e) {
                            }
...
//                             if (!read.equals(baseRead)) {
//                                 System.out.println("Deletion: Corrected color read and base read do not match: " + skew.readsPassingNode[i]);
//                                 System.out.println("color: " + read + "\nbase: " + baseRead);
...
//                             }
    ...
    // Return the number of corrected deletions
    private int correctBaseSpaceDeletionN(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int deletions = 0;
...
//                                     }
    ...
    // Return the number of corrected insertions
    private int correctBaseSpaceInsertion(String key, AlphaSuffixNode skew, ArrayList<AlphaSuffixNode> reliableNodes) {
        int insertions = 0;
        ...
        for (AlphaSuffixNode reliable : reliableNodes) {
            ...
            for(int i = 0; i < 4; i++) {
                if (combinedColors[color2int((char)reliable.getColor())][i] == 
                    color2int(skew.getColor())) {
                                ...
                                try {
                                    ...
                                    if (skew.readsPassingNode[i] % 2 == 0) {
                                        correctToBase = baseColor2Base
                                            ...
                                            [color2int(reliable.getColor())];
                                        baseRead = baseRead.substring(0,errPos-1) +
                                            correctToBase + baseRead.substring(errPos-1);
                                    } else {
                                        int blen = baseRead.length();
                                        correctToBase = baseColor2Base
                                            [base2int(baseRead.charAt(blen - errPos - 1))]
                                            [color2int(reliable.getColor())];
                                        baseRead = baseRead.substring(0,blen - errPos -1) +
                                            correctToBase + baseRead.substring(blen-errPos-1);
                                    }
                                    insertions++;
                                } catch (Exception e) {
...
//                                 if (!read.equals(baseRead)) {
//                                     System.out.println("Insertion: Corrected color read and base read do not match: " + skew.readsPassingNode[i]);
//                                     System.out.println("color: " + read + "\nbase: " + baseRead);
//                                     if (skew.readsPassingNode[i] % 2 == 0) {
//                                         System.out.println("Forward strand");
//                                     } else {
...
//                                 }
    ...
    public void buildAndProcess() {
        ...
        for (int readNumber = 0; readNumber < ColorShrec.reads.length; readNumber++) {
            ...
            int len =  (readNumber %2 == 0) ? ColorShrec.reads[readNumber].length : ColorShrec.reads[readNumber].length - 2;
...
//             if (ratio > 1.5) {
            ...
            ArrayList<AlphaSuffixNode> skewNodes = new ArrayList<AlphaSuffixNode>(0);
            ArrayList<AlphaSuffixNode> reliableNodes = new ArrayList<AlphaSuffixNode>(0);
            ...
            if (skewNodes.size() > 0 && reliableNodes.size() > 0) {
                ...
                for (AlphaSuffixNode skew : skewNodes) {
                    ...
                    if (skew.colorReads) {
                        int mism = correctColorSpaceMismatch(root.key, skew, reliableNodes);
                        mismatches += mism;
                        
                        if (mism == 0) {
                            // mismatch could not correct the error, try a deletion
                            int del = correctColorSpaceDeletion(root.key, skew, reliableNodes);
                            deletions += del;

                            if (del == 0 && skew.getColor() != '.') {
                                // mismatch or deletion did not do the trick, try insertion
                                int ins = correctColorSpaceInsertion(root.key, skew, reliableNodes);
                                insertions += ins;
                            }
                        }
                    }
                    if (skew.baseReads) {
                        ...
                        if (skew.getColor() == '.') {
                            // Handle . as a special case. Allow only mismatches or deletions
                            // try a mismatch first
                            int mism = correctBaseSpaceMismatchN(root.key, skew, reliableNodes);
                            mismatches2 += mism;

                            if (mism == 0) {
                                // mismatch did not correct the read, try a deletion
                                int del = correctBaseSpaceDeletionN(root.key, skew, reliableNodes);
                                deletions2 += del;
                            }
                        } else {
                            // Try a mismatch
                            int mism = correctBaseSpaceMismatch(root.key, skew, reliableNodes);
                            mismatches2 += mism;

                            if (mism == 0) {
                                // mismatch could not correct the error, try a deletion
                                int del = correctBaseSpaceDeletion(root.key, skew, reliableNodes);
                                deletions2 += del;

                                if (del == 0) {
                                    // mismatch or deletion did not do the trick, try insertion
                                    int ins = correctBaseSpaceInsertion(root.key, skew, reliableNodes);
                                    insertions2 += ins;
                                }
                            }
                        }
...
//                 AlphaSuffixNode node;
        ...
        ColorShrec.supervisor.processFinished(mismatches, insertions, deletions, 
                                         mismatches2, insertions2, deletions2);
    }
...
class Supervisor extends Thread {
    ...
    // toLevel increased from basic Shrec because correcting indels seems to require more accuracy
    ...
    public void run() {
        ...
        for (int y = 0; y < numberOfIterations; y++) {
            ...
            // statistics...
            System.out.println("Mismatches(color): " + mismatches + " Deletions(color): " + deletions + " Insertions(color): " + insertions);
            System.out.println("Mismatches(base): " + mismatches2 + " Deletions(base): " + deletions2 + " Insertions(base): " + insertions2);
    ...
    public void processFinished(int mismatches, int insertions, int deletions, int mismatches2, int insertions2, int deletions2) {
...
public class ColorShrec {
  ...
  // the Fasta Comments for each read
    ...
    public static void main(String[] args) throws Exception {
        ...
        Supervisor.isColorSpaceFile = 
            new boolean[args.length-inputFilesIndex];
        ...
        System.out.println(basereadcount + " base space reads and " + (readcount-basereadcount) + 
                           " color space reads.");
